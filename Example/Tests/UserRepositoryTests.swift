...
class UserRepositoryTests: XCTestCase {
    ...
    var repository: TestUserRepository!
    ...
    override func setUp() {
        ...
        self.repository = TestUserRepository(backend: backend)
    }
...
extension CRUDRepositoryTests {
    ...
    func testFindActiveUsersFailureParsingErrorCallback() {
        
        // Simulated completion
        self.backend.completion = { completion in
            let wrongDictionary = ["id": "1", "name": "_"] // lacks 'email' field
